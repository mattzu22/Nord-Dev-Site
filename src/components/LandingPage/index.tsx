...
export function LandingPage() {
  ...
  return (
    <div>
      ...
      <section className="max-w-[2000px] bg- relative flex flex-col tabletLG:flex-row tabletLG:justify-center laptopSM:mx-auto laptopSM:items-center overflow-hidden" id="quem-somos">
