...
export function About() {
  return (
    <section className="max-w-[2000px] relative flex flex-col tabletLG:flex-row tabletpLG:justify-center laptopSM:mx-auto laptopSM:items-center" id="quem-somos">
      <div className="h-[460px] flex items-center border-t-[1rem] border-yellow-500 w-full justify-center laptopSM:relative tabletLG:border-l-[1.3rem] tabletMD:h-[400px] tabletLG:border-t-0 tabletLG:h-[500px] laptopLG:h-[633px] tabletLG:max-w-full tabletLG:justify-normal">
        <Image
