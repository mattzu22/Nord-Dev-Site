...
export function About() {
  return (
    <section className="max-w-[1440px] relative flex flex-col laptopMD:flex-row laptoptMD:justify-center laptopMD:mx-auto laptopMD:items-center ">
      <div className="h-[320px] flex items-center border-t-[1rem] border-yellow-500 w-full laptopMD:relative laptopMD:border-l-[1.3rem] tabletMD:h-[400px] laptopMD:border-t-0 laptopMD:h-[633px] laptopMD:max-w-full">
        <Image
          className="block h-full -z-10 border-top laptopMD:hidden"
          src={bgAboutMobile}
          alt=""
        />
        <Image
        ...
        <div className="absolute max-w-[656px]  px-[2rem] flex justify-center flex-col gap-[1.3rem] pb-[3.5rem] tabletSM:px-[4rem] laptopMD:px-0 laptopMD:pb-0 laptopMD:ml-[8.2rem]">
          <h2 className="before:bg-white before:w-[3rem] before:h-[1px] after:bg-white after:w-[3rem] after:h-[1px] text-[1.2rem] font-[300] mb-[1.3rem] text-center flex justify-center items-center gap-[1.9rem] tabletSM:text-[1.6rem] tabletMD:text-[3rem]">
            SOMOS UMA EMPRESA (Especializada)
          </h2>

          <p className="text-[1.5rem] font-[600] tabletSM:text-[1.9rem] tabletMD:text-[3.9rem]">
      ...
      />
      <Image
        className="tabletMD:block hidden absolute right-0 -z-10"
