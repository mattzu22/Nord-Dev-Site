  ...
  return (
    <section className="flex items-center justify-center relative w-full">
      ...
      <div className="absolute text-center px-[3.5rem] max-w-[1330px]">
        ...
        <h2 className="text-[3.6rem] font-[700] pb-[5rem] tabletSM:text-[5rem] tabletSM:px-[6rem] tabletMD:px-[3rem] laptopMD:text-[7rem]">E garantir o <span className="text-yellow-500">sucesso da sua empresa</span> no mundo digital</h2>
